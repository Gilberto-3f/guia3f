...
INSERT INTO public.canais (nome, tipo_publico, categoria, pais, ordem_tipo, ordem_posicao, ativo)
VALUES ('Serviços Locais', 'empresa', 'servicos_locais', 'geral', 'rotativo', NULL, TRUE)
ON CONFLICT (nome, tipo_publico) DO UPDATE
SET
