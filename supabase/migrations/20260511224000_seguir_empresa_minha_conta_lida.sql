-- Seguir empresa aparece na Minha Conta da empresa, mas não deve gerar badge vermelho.
...
'Após favoritar empresa: mostra na Minha Conta da empresa, mas lida=true para não gerar badge vermelho.';
