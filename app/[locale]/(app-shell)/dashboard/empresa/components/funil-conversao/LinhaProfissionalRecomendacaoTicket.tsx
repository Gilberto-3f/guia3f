...
import type { RecomendacaoTicketProfissional } from '../../types/dashboard.types'
...
interface Props {
  profissional: RecomendacaoTicketProfissional
  naoLidas?: number
  onAberto?: () => void
  posicao?: number
}

export default function LinhaProfissionalRecomendacaoTicket({
  profissional,
  naoLidas = 0,
  onAberto,
  posicao,
  ...
  const resumo =
    total === 1 ? '1 ticket recomendado' : `${total.toLocaleString('pt-BR')} tickets recomendados`
          ...
          return (
            ...
            >
              ...
              <div className="relative h-12 w-12 shrink-0 overflow-hidden rounded-lg bg-gray-100">
                {detalhe.experiencia_foto_url ? (
                  // eslint-disable-next-line @next/next/no-img-element
                  <img
                    src={detalhe.experiencia_foto_url}
                    alt=""
