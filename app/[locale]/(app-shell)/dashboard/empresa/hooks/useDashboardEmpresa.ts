...
export const EMPRESA_SELECT =
  'id, usuario_id, nome_fantasia, nome_usuario, categoria, cidade, plano, nota_media, total_avaliacoes, docs_verificado, status, whatsapp, whatsapp_comercial, moeda_padrao, preco_ticket_inteira, preco_ticket_meia, preco_diaria, somente_anfitriao, somente_guia, somente_van'
...
export function mapEmpresaRow(data: Record<string, unknown>): DadosEmpresa {
  ...
  return {
    ...
    somente_van: Boolean(data.somente_van),
  }
}
