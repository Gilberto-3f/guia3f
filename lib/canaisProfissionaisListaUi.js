...
/** Rótulo do canal financeiro privado do profissional (lista + cabeçalho do detalhe). */
export const ROTULO_CANAL_FINANCEIRO_PROFISSIONAL = 'Canal Financeiro do Profissional'
...
export function rotuloCanalListaProfissional(c, isFinanceiro) {
  if (typeof isFinanceiro === 'function' && isFinanceiro(c.nome)) {
    return ROTULO_CANAL_FINANCEIRO_PROFISSIONAL
  }
