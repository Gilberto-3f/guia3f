...
export const ROTULO_CANAL_SEGMENTO_EMPRESA = {
  Restaurantes: 'Canal - Seguimento GASTRONOMIA',
  Atrativos: 'Canal - Seguimento ATRATIVOS',
  Lojas: 'Canal - Seguimento LOJAS',
  Hospedagem: 'Canal - Seguimento HOSPEDAGEM',
}
