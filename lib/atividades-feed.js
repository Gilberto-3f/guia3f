...
export function produtosSnapCatalogoPost(p) {
  ...
  const chave = Array.isArray(meta.atrativos)
    ? 'atrativos'
...
/**
 * @param {PostMeta | undefined | null} p
 * @returns {'foto' | 'texto' | 'avaliacao' | 'repost' | 'verificacao_profissional' | 'catalogo_produtos' | 'catalogo_cardapio' | 'catalogo_servicos' | 'catalogo_atrativos'}
 */
