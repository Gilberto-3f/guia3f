...
export function produtosSnapCatalogoPost(p) {
  ...
  const raw = Array.isArray(meta.produtos) ? meta.produtos : []
  ...
  for (const item of raw.slice(0, 3)) {
    ...
    out.push({
      ...
      nome: typeof o.nome === 'string' ? o.nome : 'Produto',
    })
  }
  return out
}
...
/**
 * @param {PostMeta | undefined | null} p
 * @returns {'foto' | 'texto' | 'avaliacao' | 'repost' | 'verificacao_profissional' | 'catalogo_produtos'}
 */
