                    ...
                    <>
                      ...
                      <div className="flex items-end gap-2 border-t border-gray-200 bg-white px-3 py-2">
                        <input
                          ...
                          className={`min-h-[40px] min-w-0 flex-1 rounded-xl border border-gray-200 px-3 py-2 text-sm outline-none focus:border-[#0097b2] ${INPUT_FIN}`}
                        />
                        <button
                          type="button"
...
function ListaMensagensFinanceiro({
  ...
  return (
    <div className={`overflow-y-auto bg-[#e5ddd5] px-3 py-3 ${className}`}>
      {mensagens.map((m) => {
            ...
            >
              ...
              {m.anexo_url && m.anexo_tipo === 'documento' ? (
                <a
                  ...
                  className="mt-0.5 block text-sm font-medium text-[#0097b2] underline"
                >
                  Ver anexo
                </a>
              ) : null}
